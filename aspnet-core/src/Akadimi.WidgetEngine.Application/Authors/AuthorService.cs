...
{
    [Authorize(WidgetEnginePermissions.Authors.Default)]
    public class AuthorService : WidgetEngineAppService, IAuthorService
    {
        ...
        [Authorize(WidgetEnginePermissions.Authors.Create)]
        ...
        [Authorize(WidgetEnginePermissions.Authors.Edit)]
        ...
        [Authorize(WidgetEnginePermissions.Authors.Delete)]
